...
impl MempoolMonitor {
    ...
    pub async fn new(
        ...
        let database_tracker =
            DatabaseTracker::new(crate::database_tracker::DatabaseConfig::default());
    ...
    async fn scan_liquidation_opportunities(
        ...
        for opportunity in liquidation_opportunities {
            ...
            if let Err(e) = self
                .database_tracker
                .track_liquidation_opportunity(&opportunity)
                .await
            {
    ...
    async fn report_statistics(&self) {
        ...
        info!(
            "  📊 Database: {} opportunities tracked, {:.2}MB",
    ...
    pub async fn generate_performance_report(
        &self,
        hours: u64,
    ) -> Result<crate::database_tracker::PerformanceReport> {
        self.database_tracker
